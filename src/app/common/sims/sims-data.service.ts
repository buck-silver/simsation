...
import { SimsAchievement } from './types/sims-achievement';
...
export class SimsDataService {
  ...
  getAchievements(game: 'sims4'): Observable<SimsAchievement[]> {
    return this.http.get<SimsAchievement[]>(`/api/sims/achievements/${game}`);
  }
